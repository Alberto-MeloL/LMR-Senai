<template>
    ...
    methods: {
    // Método para buscar dados de clima ao pressionar a tecla Enter na caixa depesquisa
    fetchClima(e) {
    if (e.key == "Enter") {
    ...
    * {
    ...
    #clima {
    background-image: url('../assets/frio.png');
    ...
    temperatura) */
    #clima.warm {
    background-image: url('../assets/calor.png');
